...
const ProjectRight = ({project}) => {
  return (
    <motion.div variants={fadeIn('up','tween', 0, .6)} initial="hidden" whileInView="show" viewport={{once: 'false', amount: 0.2}} transition={{when: "beforeChildren"}} className='grid grid-cols-12'>
